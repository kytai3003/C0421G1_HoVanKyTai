...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-lg-10" style="background-image: url('https://trungtaminan.com.vn/wp-content/uploads/2020/06/background-in-an-2-1536x1152.jpg'); height: 400px">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 style="text-align: center">Create New Contract</h1>
                    <center>
                        <p>
                        ...
                        <form method="post" style="alignment: center">
                            ...
                            <table align="center">
                                ...
                                <tr>
                                    <td>Employee name: </td>
                                    <td>
                                        <select name="employee" style="width: 182px">
                                ...
                                <tr>
                                    <td>Customer name: </td>
                                    <td>
                                        <select name="customer" style="width: 182px">
                                ...
                                <tr>
                                    <td>Service name: </td>
                                    <td>
                                        <select name="service" style="width: 182px">
                                ...
                                <tr>
                                    <td></td>
                                    <td>
                                        <button class="rounded-pill my-lg-1" type="submit" style="width: 160px; height: 50px">Create</button>
                                    </td>
                                </tr>
                            </table>
                        </form>
