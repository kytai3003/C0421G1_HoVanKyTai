            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p style="display: flex; flex-direction: column; justify-content: center; color: black; text-indent: 25px">
                        A well-appointed International Convention Palace with ballrooms can accommodate up
                        to 1,000 people in style, with another ten function rooms for 50 to 300 people each.
                        A variety of cultural-themed parties on the beach or around the lagoon, in the
                        ballrooms or outside the resort, with the surprising arrivals of VIPs from Helicopter
                        landing on the resort’s own Helipad, plus exciting team building activities and water
                        sports, two 18-hole golf courses nearby, as well as health and beauty service make the
                        Furama Danang the ideal venue for MICE groups for conference and incentive planners.
                    </p>
                    <img src="img/meeting_room.jpg" style="width: 100%">
                    <p style="display: flex; flex-direction: column; justify-content: center; color: black; text-indent: 25px">
                        Furama Resort Danang is a place to awaken your senses, engage your mind, emerge big ideas
                        and also grow your imagination. Our conference and meeting rooms have seen and hosted many
                        international congress, conventions and special banquets that link between thinkers in business,
                        government and uniquely tailored event to suit every need…
                    </p>
                </div>
            </div>
        </div>
