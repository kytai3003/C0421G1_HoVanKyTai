...
public class Service {
    ...
    @ManyToOne(targetEntity = ServiceType.class, cascade = CascadeType.ALL)
    @JoinColumn(name = "service_type_id", referencedColumnName = "serviceTypeId")
    private ServiceType serviceType;

    @ManyToOne(targetEntity = RentType.class, cascade = CascadeType.ALL)
    ...
    public Service(String serviceName, int serviceArea, double serviceCost, int serviceCapacity, String standardRoom, String otherConvenience, double poolArea, int numberOfFloor, ServiceType serviceType, RentType rentType, List<Contract> contract) {
